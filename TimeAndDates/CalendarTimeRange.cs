...
namespace TimeAndDates
{
    public class CalendarTimeRange : TimeRange, ICalendarTimeRange
    {
        ...
        // ----------------------------------------------------------------------
        public DateTime FirstMonthStart => new(Start.Year, Start.Month, 1); // FirstMonthStart

        // ----------------------------------------------------------------------
        public DateTime LastMonthStart => new(End.Year, End.Month, 1); // LastMonthStart

        // ----------------------------------------------------------------------
        public DateTime FirstDayStart => new(Start.Year, Start.Month, Start.Day); // FirstDayStart

        // ----------------------------------------------------------------------
        public DateTime LastDayStart => new(End.Year, End.Month, End.Day); // LastDayStart

        // ----------------------------------------------------------------------
        public DateTime FirstHourStart => new(Start.Year, Start.Month, Start.Day, Start.Hour, 0, 0); // FirstHourStart

        // ----------------------------------------------------------------------
        public DateTime LastHourStart => new(End.Year, End.Month, End.Day, End.Hour, 0, 0); // LastHourStart

        // ----------------------------------------------------------------------
        public DateTime FirstMinuteStart => new(Start.Year, Start.Month, Start.Day, Start.Hour, Start.Minute, 0, 0); // FirstMinuteStart

        // ----------------------------------------------------------------------
        public DateTime LastMinuteStart => new(End.Year, End.Month, End.Day, End.Hour, End.Minute, 0, 0); // LastMinuteStart
